...
-- Tabela de clientes (pessoas que contratam serviços)
...
-- Tabela de empresas (prestadoras de serviço)
...
-- Tabela de serviços (ofertados pelas empresas)
...
-- Tabela de orçamentos (solicitações de clientes)
