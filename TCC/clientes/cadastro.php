...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erros)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO clientes (nome, email, senha, telefone, endereco, tipo, cpf_cnpj) VALUES (?, ?, ?, ?, ?, ?, ?)");
            ...
            <form method="post">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <?php if (isset($erros['nome'])): ?>
                            <small class="error-text"><?= $erros['nome'] ?></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="cpf_cnpj" class="form-control" value="<?= htmlspecialchars($cpf_cnpj ?? '') ?>" placeholder="000.000.000-00">
                    </div>
                </div>
